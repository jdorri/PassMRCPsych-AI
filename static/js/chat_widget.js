(function() {
      ...
      <div id="chat-popup" class="hidden absolute bottom-20 right-0 w-96 bg-white rounded-md shadow-md flex flex-col transition-all text-sm">
        ...
        <div id="chat-input-container" class="p-4 border-t border-gray-200">
          ...
          <div class="flex text-center text-xs pt-4">
            <span class="flex-1">Prompted by <a href="https://twitter.com/jamdorricott" target="_blank" class="text-indigo-600">@anantrp</a></span>
          </div>
        </div>
      </div>
    `;
    ...
    function sendUserMessageToServer(message) {
      ...
      const serverAddress = 'http://44.226.145.213:5601';
      ...
      fetch(`${serverAddress}/chat`, {
        ...
        .then(response => {
          if (response.status === 200) {
            ...
            // Handle non-OK status codes (e.g., 400 for bad requests)
